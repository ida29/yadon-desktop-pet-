...
RANDOM_MESSAGES = [
    "きょうもがんばってるやぁん",
    "おつかれさまやぁん",
    "すごいやぁん...なにがすごいかわからないけどやぁん",
    "きょうはなんようびだっけやぁん",
    "あ、しごとしてるやぁん",
    "ねむくないやぁん？",
    "たまにはきゅうけいするやぁん",
    "がんばってるね...なにをかはわからないやぁん",
    "えらいやぁん！...たぶんやぁん",
    "そのボタンおすやぁん...どのボタンかはしらないやぁん",
    "コーヒーのむやぁん？...いれかたしらないやぁん",
    "しゅうちゅうしてるやぁん...なにかにやぁん",
    "きょうはいいてんきやぁん...まどないけどやぁん",
    "ぼくねむいやぁん...いつもねむいやぁん",
    "ファイトやぁん！...なにとたたかってるかしらないやぁん"
]
...
# Position Constants
YADON_POSITIONS = [
    (0.25, 0.33),  # Top-left (as screen fractions)
    (0.75, 0.33),  # Top-right
    (0.25, 0.67),  # Bottom-left
    (0.75, 0.67)   # Bottom-right
]
